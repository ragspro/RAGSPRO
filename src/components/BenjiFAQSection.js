        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            {faqData.map((faq, index) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <motion.button
                    className="ml-4 w-8 h-8 rounded-full bg-white flex items-center justify-center text-gray-600 hover:bg-black hover:text-white transition-all duration-300"
          ...
          <div className="lg:pl-8">
            ...
            >
              ...
              {/* Content */}
              <div className="mb-8">
                <p className="text-gray-500 text-lg mb-2">Still not sure?</p>
              ...
              {/* CTA Button */}
              <motion.button
                className="w-full bg-black text-white py-4 px-6 rounded-2xl font-semibold text-lg hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl"
...
export default BenjiFAQSection