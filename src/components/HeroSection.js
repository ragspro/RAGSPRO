...
export default function HeroSection() {
  ...
  return (
    <main>
      <section 
        className="relative min-h-screen flex items-center overflow-hidden bg-black hero-section pt-16 xs:pt-20 md:pt-0"
        aria-label="Hero section - RAGSPRO AI Product Development Agency"
      >
        <div className="container mx-auto px-3 xs:px-4 sm:px-6 flex flex-col md:flex-row items-center relative w-full">
          <header className="w-full md:w-1/2 text-left mb-4 xs:mb-6 md:mb-0 hero-content">
            <motion.div
            ...
            <nav className="flex flex-col xs:flex-row gap-2 xs:gap-3" aria-label="Primary actions">
              <button 
                ...
                aria-label="Book free strategy call with RAGSPRO"
              >
              ...
              <button 
                ...
                aria-label="View RAGSPRO portfolio and projects"
              >
                View Our Work
              </button>
            </nav>
          ...
          <aside 
            className="w-full md:w-1/2 h-[250px] xs:h-[300px] sm:h-[400px] md:h-[600px] relative three-canvas"
