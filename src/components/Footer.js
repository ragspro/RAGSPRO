...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#000000] text-white pt-12 md:pt-16 pb-0 relative">
      ...
      <div className="max-w-[1200px] mx-auto px-8 md:px-12 relative z-10">
        ...
        <div className="mb-8 mt-8">
          <h2 className="text-[56px] md:text-[64px] font-normal leading-[0.6] tracking-tight">
            <span className="text-white flex items-baseline relative z-20">
              <span className="text-white font-normal mr-4">Let's </span>
              <span className="inline-block relative overflow-hidden h-[1.2em] min-w-[200px]">
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="absolute inset-0 flex items-end pb-1 text-white font-normal"
                  >
                    {words[currentWord]}
                  </motion.span>
                </AnimatePresence>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12 mt-6">
          {/* Email Section */}
        ...
        {/* Divider */}
        <div className="border-t border-[#222222] mb-6"></div>
        ...
        <div className="-mt-2 text-center relative overflow-hidden">
          <h3 className="text-[100px] md:text-[130px] lg:text-[160px] font-normal text-white leading-none tracking-tight whitespace-nowrap">
            START TODAY
          </h3>
        </div>
      </div>
